(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('tslib'), require('@zilliqa-js/core'), require('@zilliqa-js/crypto'), require('@zilliqa-js/util'), require('@zilliqa-js/account')) :
  typeof define === 'function' && define.amd ? define(['exports', 'tslib', '@zilliqa-js/core', '@zilliqa-js/crypto', '@zilliqa-js/util', '@zilliqa-js/account'], factory) :
  (factory((global.zjsBlockchain = {}),global.tslib,global['@zilliqa-js/core'],global['@zilliqa-js/crypto'],global['@zilliqa-js/util'],global['@zilliqa-js/account']));
}(this, (function (exports,tslib,core,crypto,util,account) { 'use strict';

  //  Copyright (C) 2018 Zilliqa
  function toTxParams(response) {
      var _a = response.result, toAddr = _a.toAddr, senderPubKey = _a.senderPubKey, gasPrice = _a.gasPrice, gasLimit = _a.gasLimit, nonce = _a.nonce, amount = _a.amount, receipt = _a.receipt, version = _a.version, code = _a.code, data = _a.data, rest = tslib.__rest(_a, ["toAddr", "senderPubKey", "gasPrice", "gasLimit", "nonce", "amount", "receipt", "version", "code", "data"]);
      var msg = receipt.errors
          ...
          : {};
      return tslib.__assign(tslib.__assign({}, rest), { version: parseInt(version, 10), toAddr: crypto.toChecksumAddress(toAddr), pubKey: senderPubKey.replace('0x', ''), gasPrice: new util.BN(gasPrice), gasLimit: util.Long.fromString(gasLimit, 10), amount: new util.BN(amount), nonce: parseInt(nonce, 10), code: code, data: data, receipt: tslib.__assign(tslib.__assign({}, receipt), { accepted: receipt.accepted, errors: msg, cumulative_gas: parseInt(receipt.cumulative_gas, 10) }) });
  }
  ...
  var Blockchain = /** @class */ (function () {
          ...
          return tslib.__awaiter(this, void 0, void 0, function () {
              ...
              return tslib.__generator(this, function (_a) {
                  switch (_a.label) {
                      case 0:
                          _a.trys.push([0, 2, , 3]);
                          return [4 /*yield*/, this.provider.send(core.RPCMethod.CreateTransaction, tslib.__assign(tslib.__assign({}, tx.txParams), { priority: tx.toDS }))];
                      case 1:
                          response = _a.sent();
                          if (response.error) {
                      ...
                      case 0:
                          ...
                          try {
                              for (signedTxList_1 = tslib.__values(signedTxList), signedTxList_1_1 = signedTxList_1.next(); !signedTxList_1_1.done; signedTxList_1_1 = signedTxList_1.next()) {
                                  ...
                                  txParamsList.push(tslib.__assign(tslib.__assign({}, signedTx.txParams), { priority: signedTx.toDS }));
                              }
                          }
          ...
          return tslib.__awaiter(this, void 0, void 0, function () {
              ...
              return tslib.__generator(this, function (_a) {
                  switch (_a.label) {
                      case 0:
                          _a.trys.push([0, 2, , 3]);
                          return [4 /*yield*/, this.provider.send(core.RPCMethod.GetTransaction, txHash.replace('0x', ''))];
                      case 1:
                          response = _a.sent();
                          if (response.error) {
          ...
          return tslib.__awaiter(this, void 0, void 0, function () {
              ...
              return tslib.__generator(this, function (_a) {
                  switch (_a.label) {
                      case 0:
                          _a.trys.push([0, 2, , 3]);
                          return [4 /*yield*/, this.provider.send(core.RPCMethod.GetTransactionStatus, txHash.replace('0x', ''))];
                      case 1:
                          response = _a.sent();
                          if (response.error) {
                              return [2 /*return*/, Promise.reject(response.error)];
      ...
      Blockchain.prototype.getStateProof = function (contractAddress, sha256Hash, txBlock) {
          var address = util.validation.isBech32(contractAddress)
              ? crypto.fromBech32Address(contractAddress)
              : contractAddress;
