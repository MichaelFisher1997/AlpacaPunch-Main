(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('tslib'), require('@zilliqa-js/core'), require('@zilliqa-js/util'), require('@zilliqa-js/proto'), require('@zilliqa-js/crypto'), require('bip39'), require('hdkey')) :
  typeof define === 'function' && define.amd ? define(['exports', 'tslib', '@zilliqa-js/core', '@zilliqa-js/util', '@zilliqa-js/proto', '@zilliqa-js/crypto', 'bip39', 'hdkey'], factory) :
  (factory((global.zjsAccount = {}),global.tslib,global['@zilliqa-js/core'],global['@zilliqa-js/util'],global['@zilliqa-js/proto'],global['@zilliqa-js/crypto'],global.bip39,global.hdkey));
}(this, (function (exports,tslib,core,util,proto,zcrypto,bip39,hdkey) { 'use strict';
  ...
  var encodeTransactionProto = function (tx) {
      var msg = {
          ...
          code: tx.code && tx.code.length
              ? Uint8Array.from(tslib.__spreadArray([], tslib.__read(tx.code), false).map(function (c) { return c.charCodeAt(0); }))
              : null,
          data: tx.data && tx.data.length
              ? Uint8Array.from(tslib.__spreadArray([], tslib.__read(tx.data), false).map(function (c) { return c.charCodeAt(0); }))
              : null,
      };
  ...
  var formatOutgoingTx = function (req) {
      ...
      if (Array.isArray(req.payload) &&
          ...
          try {
              for (var _b = tslib.__values(req.payload), _c = _b.next(); !_c.done; _c = _b.next()) {
                  ...
                  payloads.push(tslib.__assign(tslib.__assign({}, txPayload), { params: [
                          tslib.__assign(tslib.__assign({}, txConfig), { amount: txConfig.amount.toString(), gasLimit: txConfig.gasLimit.toString(), gasPrice: txConfig.gasPrice.toString() }),
                      ] }));
              }
          }
          ...
          var ret = tslib.__assign(tslib.__assign({}, req), { payload: payloads });
          return ret;
      }
      ...
      if (!Array.isArray(req.payload) &&
          ...
          var ret = tslib.__assign(tslib.__assign({}, req), { payload: tslib.__assign(tslib.__assign({}, req.payload), { params: [
                      tslib.__assign(tslib.__assign({}, txConfig), { amount: txConfig.amount.toString(), gasLimit: txConfig.gasLimit.toString(), gasPrice: txConfig.gasPrice.toString() }),
                  ] }) });
          return ret;
      }
  ...
  var Wallet = /** @class */ (function (_super) {
      ...
      Wallet.prototype.remove = function (address) {
          if (this.accounts[address]) {
              var _a = this.accounts, _b = address, toRemove = _a[_b], rest = tslib.__rest(_a, [typeof _b === "symbol" ? _b : _b + ""]);
              this.accounts = rest;
              return true;
          }
          return false;
              ...
              return tslib.__generator(this, function (_a) {
                  switch (_a.label) {
                      ...
                      case 1:
                          ...
                          return [4 /*yield*/, this.provider.send(core.RPCMethod.GetBalance, signer_1.address.replace('0x', '').toLowerCase())];
                      case 2:
                          balance = _a.sent();
                                  ...
                                  switch (_b.label) {
                                      case 0:
                                          ...
                                          withNonceTx = txList[index].map(function (txObj) {
                                              return tslib.__assign(tslib.__assign({}, txObj), { nonce: currentNonce, pubKey: signer_1.publicKey });
                                          });
              ...
              return tslib.__generator(this, function (_a) {
                  switch (_a.label) {
                      ...
                      case 1:
                          ...
                          return [4 /*yield*/, this.provider.send(core.RPCMethod.GetBalance, signer.address.replace('0x', '').toLowerCase())];
                      case 2:
                          balance = _a.sent();
                          if (balance.result === undefined) {
                              throw new Error('Could not get balance');
                      ...
                      case 3:
                          withNonce_1 = tx.map(function (txObj) {
                              return tslib.__assign(tslib.__assign({}, txObj), { nonce: txObj.nonce || currNonce + 1, pubKey: signer.publicKey });
                          });
                          return [2 /*return*/, withNonce_1.map(function (txObj) {
                                  // @ts-ignore
                                  return tslib.__assign(tslib.__assign({}, txObj), { signature: signer.signTransaction(withNonce_1.bytes) });
                              })];
                      case 4:
                          withPublicKey = tx.map(function (txObj) {
                              return tslib.__assign(tslib.__assign({}, txObj), { pubKey: signer.publicKey });
                          });
                          return [2 /*return*/, withPublicKey.map(function (txObj) {
                                  return tslib.__assign(tslib.__assign({}, txObj), { signature: signer.signTransaction(tx.bytes) });
                              })];
                      case 5:
                          err_2 = _a.sent();
                          throw err_2;
  ...
  var Transaction = /** @class */ (function () {
              ...
              return tslib.__generator(this, function (_a) {
                  switch (_a.label) {
                      ...
                      case 1:
                          ...
                          this.receipt = tslib.__assign(tslib.__assign({}, res.result.receipt), { cumulative_gas: parseInt(res.result.receipt.cumulative_gas, 10) });
      ...
      Transaction.prototype.emit = function (event, txEvent) {
          this.eventEmitter.emit(event, tslib.__assign(tslib.__assign({}, txEvent), { event: event }));
      };
      return Transaction;
  }());
